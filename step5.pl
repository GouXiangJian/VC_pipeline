...
my $VERSION = 'variant (SNP/INDEL) calling, step5 v1.0 (2021.11.27)';

#set default options
my $population = "barley.wgs.5";
my $filterScript = "/public/home/xjgou/base_composition/six_sample/snpFilter.pl";
my $filterMAF = 0.05;
my $filterMR = 0.2;
...
Options:
  ...
  -p  | -population   <STRING> : the population name. (default: barley.wgs.5)
  -fs | -filterScript <STRING> : the filtering script. (default: /public/home/xjgou/base_composition/six_sample/snpFilter.pl)
