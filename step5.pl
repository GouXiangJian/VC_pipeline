...
my $VERSION = 'variant (SNP/INDEL) calling, step5 v1.1 (2025-03-11)';
...
Options:
  ...
  -t  | -thread       <INT>    : set the number of threads to use. (default: 1)
  -m  | -memory       <INT>    : set the size of memory to use. (default: 200 [200GB])
